      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div
                      className={`w-12 h-12 rounded-2xl border flex items-center justify-center text-2xl ${config.color}`}
                    >
                      {config.icon}
                    </div>
        ...
        >
          ...
          <p className="text-white/60 text-sm mb-6">
            Create a free account or sign in to make booking requests.
          </p>
        ...
        >
          ...
          >
            <div className="flex items-start justify-between mb-6">
              <div
                className={`w-14 h-14 rounded-2xl border flex items-center justify-center text-3xl ${typeConfig[selected.type]?.color || 'bg-slate-50'}`}
              >
            ...
            <div className="bg-teal-50 rounded-2xl p-4 text-center border border-teal-100">
              ...
              <div className="flex gap-2">
                <Link
                  to="/login"
                  className="flex-1 py-2 bg-white border border-teal-200 text-teal-600 font-semibold rounded-xl text-sm hover:bg-teal-50 transition-colors"
                >
                  Login
                </Link>
                <Link
