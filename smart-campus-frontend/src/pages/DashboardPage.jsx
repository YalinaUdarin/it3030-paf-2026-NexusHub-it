      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(79,70,226,0.15) 0%, transparent 70%)',
          }}
        />
        <div
          style={{
      ...
      <div className="space-y-6 relative">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map(({ label, value, icon: Icon, gradient, glow, sub }) => (
            ...
            >
              <div
                className={`w-11 h-11 rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center mb-4 shadow-lg ${glow}`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                ...
                {tickets.map((t) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-slate-800 group-hover:text-pink-600 transition-colors truncate max-w-36">
                          {t.title}
                        </p>
                        <p className="text-xs text-slate-400">
          ...
          <div
            style={{
              background:
                'linear-gradient(135deg, #4f46e2 0%, #7c3aed 50%, #ec4899 100%)',
              borderRadius: '2rem',
            }}
