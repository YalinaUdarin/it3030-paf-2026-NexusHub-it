  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          'linear-gradient(135deg, #e8f5f0 0%, #f0f9ff 40%, #e8f4fd 70%, #f0fdf4 100%)',
      }}
    >
      <div className="w-full max-w-md">
        ...
        <Link
          to="/landing"
          className="flex items-center gap-1 text-xs font-semibold text-teal-600 uppercase tracking-widest mb-6 hover:text-teal-700 transition-colors"
        >
          ← Back to Home
        </Link>
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/60 border border-white/80 p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Sign in to continue your operations
            </p>
          </div>
          ...
          <div className="flex gap-2 mb-6 p-1 bg-slate-100 rounded-2xl">
            <div
              className="flex-1 py-2 text-center text-sm font-bold text-white rounded-xl shadow"
              style={{
            ...
            <Link
              to="/register"
              className="flex-1 py-2 text-center text-sm font-semibold text-slate-500 rounded-xl hover:text-slate-700 transition-colors"
            >
              Register
            </Link>
          </div>
