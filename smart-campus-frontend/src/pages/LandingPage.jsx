...
const slides = [
  {
    ...
    subtitle:
      'Manage resources, bookings, maintenance tickets, and role-based operations through a secure campus portal.',
  },
  {
    image: '/hero2.jpg',
    ...
    subtitle:
      'Reserve lecture halls, labs, meeting rooms and equipment with real-time conflict detection.',
  },
  {
    image: '/hero3.jpg',
    ...
    subtitle:
      'Submit maintenance tickets with photo evidence and monitor every update from open to closed.',
  },
];
...
const features = [
  {
    ...
    desc: 'Discover lecture halls, labs, rooms, and equipment with clear availability and metadata.',
  },
  {
    icon: HiCalendar,
    title: 'Booking Workflow',
    desc: 'Request, approve, and monitor bookings with conflict-free scheduling and status tracking.',
  },
  {
    icon: HiTicket,
    title: 'Maintenance Tickets',
    desc: 'Report incidents with attachments, assign technicians, and monitor full resolution timelines.',
  },
  {
    icon: HiBell,
    title: 'Live Notifications',
    desc: 'Get updates for booking decisions, ticket status changes, and comments in one panel.',
  },
];
...
const roles = [
  {
    ...
    desc: 'Book resources, report issues, and follow your requests in a simple personalized workspace.',
  },
  {
    title: 'Administrator',
    color: 'text-blue-600',
    bg: 'bg-blue-50 border-blue-100',
    desc: 'Approve bookings, govern access, and keep campus operations reliable and auditable.',
  },
  {
    title: 'Technician',
    color: 'text-violet-600',
    bg: 'bg-violet-50 border-violet-100',
    desc: 'Manage assigned incidents, update progress, and close tasks with clear resolution notes.',
  },
];
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span
              className={`font-extrabold text-lg tracking-tight transition-colors ${scrolled ? 'text-slate-900' : 'text-white'}`}
            >
              NexusHub
            </span>
          </div>
      ...
      <div className="relative h-screen min-h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center text-center px-6">
          <div className="max-w-3xl">
            ...
            <h1
              className="text-5xl lg:text-7xl font-extrabold text-white mb-4"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-slate-50 to-teal-50/30 rounded-3xl border border-slate-100 p-8 lg:p-12">
            ...
            <p className="text-slate-500 leading-relaxed max-w-3xl text-base">
              NexusHub is designed for transparent workflows, role-driven
              accountability, and reliable audit trails. From room bookings to
              incident resolution, every action is structured, trackable, and
              secure. Built for SLIIT Faculty of Computing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-slate-500 mt-3 max-w-xl mx-auto">
              Everything you need to manage campus facilities and operations in
              one place.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {features.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="bg-white rounded-2xl border border-slate-100 hover:border-teal-200 hover:shadow-lg transition-all p-6 group"
              >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-slate-500 mt-3">
              Different views and capabilities for every type of user.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {roles.map(({ title, color, bg, desc }) => (
              <div
                key={title}
                className={`rounded-2xl border p-8 ${bg} transition-all hover:-translate-y-1 hover:shadow-md`}
              >
                <h3 className={`font-extrabold text-xl mb-3 ${color}`}>
                  {title}
                </h3>
                <p className="text-sm text-slate-500 leading-relaxed">{desc}</p>
              </div>
      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/60 mb-8 text-lg">
            Join NexusHub and streamline your campus operations today.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              to="/register"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs">
                Smart Campus Operations Hub · SLIIT · Group 104
              </p>
            </div>
          </div>
