            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div
                    className={`w-12 h-12 rounded-2xl ${config.iconBg} flex items-center justify-center`}
                  >
                ...
                {/* Name */}
                <h3
                  className={`font-bold text-slate-900 ${config.hoverText} transition-colors mb-1`}
                >
                  {r.name}
                </h3>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-slate-50">
                  <span
                    className={`text-xs font-semibold px-2.5 py-1 rounded-full ${config.iconBg} ${config.iconColor}`}
                  >
                    {config.label}
                  </span>
