      ...
      <aside className="w-64 bg-white border-r border-slate-100 flex flex-col shadow-sm">
        ...
        <div className="px-5 py-5 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            <div
              className="w-9 h-9 rounded-xl flex items-center justify-center shadow-md shadow-teal-500/20"
              style={{
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
          <p className="px-3 text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 mt-1">
            Main
          </p>
          ...
          >
            <HiOfficeBuilding className="text-lg flex-shrink-0" /> Facilities &
            Assets
          </NavLink>
          <NavLink
            to="/bookings"
          ...
          {isAdmin() && (
            <>
              ...
              >
                <HiOfficeBuilding className="text-lg flex-shrink-0" /> Manage
                Resources
              </NavLink>
              <NavLink
                to="/admin/bookings"
        ...
        <div className="px-3 py-4 border-t border-slate-100">
          <div className="flex items-center gap-3 px-3 py-2.5 mb-1 bg-slate-50 rounded-xl">
            <img
              src={
                user?.picture ||
                `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || 'U')}&background=0d9488&color=fff`
              }
              alt={user?.name}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-sm font-extrabold text-slate-800 leading-tight tracking-tight">
                NexusHub — Campus Operations Portal
              </h1>
            </div>
          </div>
          <NotificationBell />
