...
export const resourceApi = {
  ...
  updateStatus: (id, status) =>
    api.patch(`/api/resources/${id}/status`, null, { params: { status } }),
...
export const ticketApi = {
  ...
  addComment: (id, content) =>
    api.post(`/api/tickets/${id}/comments`, { content }),
...
export const adminApi = {
  ...
  updateRoles: (id, roles) =>
    api.patch(`/api/admin/users/${id}/roles`, { roles }),
  toggleUser: (id, enabled) =>
    api.patch(`/api/admin/users/${id}/toggle`, { enabled }),
